...
\begin{frame}
\includegraphics<1>[width=12cm, height=8cm]{irfspread}
\end{frame}

\begin{frame}
\includegraphics<1>[width=12cm, height=8cm]{irfcot}
\end{frame}

\begin{frame}
\includegraphics<1>[width=12cm, height=8cm]{irfcnb}
\end{frame}

\begin{frame}
\includegraphics<1>[width=12cm, height=8cm]{irfs1}
\end{frame}

\begin{frame}
\includegraphics<1>[width=12cm, height=8cm]{irfcne}
\end{frame}
