...
The rapid rise in gross international capital flows (add some facts from Lane and Milessioretti and Rogoff and BIS) and the role that these flows have played in fostering international financial crisis has increased the attention on the relationships between capital flows, exchange rates and financial crisis over the last 20 years.  In the last 10 years, the evidence has accumulated that the link between international capital flows and economic development is not as evident in practice as it appears to be in theory.  For example, even before the GFC, Mishkin identified the failure of capital to flow from developed to less developed countries.  Rey(citulike) reviews the evidence on the benefits of international financial flows and finds it elusive.  Indeed, international capital flows can have a very disruptive influence.  Calvo, Krugman, Calvo et have studied the effect of \emph{sudden stops} when countries suffer the financial shock of a disruption or reversal of capital inflow.  Inflows can also cause the real exchange rate to appreciate, damaging traded goods sectors of the economy.  \emph{The Dutch Disease} is the term given to...}.  This may also extend to US and UK.  Capital inflows also disrupt and complicate the operation of domestic monetary policy.    see ???? and ??? on the \emph{trilemma}.  Most of the evidence suggests that the more short-term and speculative the capital flow, the more disruptive and less beneficial:  foreign direct investment can have a positive influence and is slow to reverse; portfolio flows are less helpful and can be swiftly withdrawn; there is much less evidence on speculation.  Need references for all of these. 
