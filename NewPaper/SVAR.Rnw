...
\date{\today}
\maketitle
  \begin{abstract}An SVAR model of the real exchange rate and intentional capital flows reveals that innovations to speculation can cause changes in competitiveness.  The addition of measures of speculation to existing models of exchange rates and international capital flows reduce the economic and statistical significance of conventional portfolio flows unless they are part of official intervention in the foreign exchange market.   This paper adds to the evidence that free movement international capital has disruptive effects that suggest policy intervention can be useful.  There is evidence that offical intervention in the foreign exchange market can be effective.  
\end{abstract}

\section{Introduction} 
The rise in gross and net international capital flows that has taken place in the last 20 years has been well documented by \citet{PLane2007}, \citet{obstfeldtaylor}, \citet{BISFX2013} and others. The evidence has accumulated that the link between international capital flows and economic development is not as prominent in practice as it appears to be in theory.  For example, even before the Global Financial Crisis (GFC), Mishkin highlighted the failure of capital to flow from developed to less developed countries as conventional theory would predict; more recently, \citet{HauEquity} review the evidence on the benefits of international financial flows and find it elusive.  

  Indeed, international capital flows can have a very disruptive influence.   There has been increased attention on the relationships between capital flows, exchange rates and financial crisis.  \citet{CalvoSS},\citet{DornbuschSS} and \citet{KrugmanSS} have studied the effect of \emph{sudden stops} when countries suffer the financial shock of a disruption or reversal of capital inflow. The research has expanded to assess the combined influence of the \emph{sudden surge} that proceeds the outflow and to a consideration of the mixture of gross inflows and outflows that affect the balance of payments.  For example, \citet{cavalloSS} provide a taxonomy of stops based on the composition of the financial account adustment and the effect that it has on economic growth, the exchange rate and inflation in the target country.   
      
This increased skepticism over the benefits of the free-flow of capital has renewed interest in capital controls and other means of reducing their influence.  This is helped by tentative evidence from Malaysia, China and Brazil that they can be effective in practice.  \citet{brunnermeier2014international} develop a two-country neoclassical stochastic growth model where banking credit can be excessive and can reverse.  Capital controls or macroprudential measures can improve model outcomes. \citet{KatanoCapital} compares the effect of capital controls and perfect capital mobility and finds that the less efficient the financial system the more likely that capital controls will be welfare enhancing. \citet{Korinek2011} makes the case for variable taxation of capital flows on the basis that individual investors do not internalise the increase in the size of the aggregate financial shock that individual inflows cause.  He calls for liquidity-adjusted taxes to price this externality.   

The attention to the liquidity of the the capital flow is a reflection the fact that evidence suggests that the more short-term and speculative the capital flow, the more disruptive and less beneficial:  foreign direct investment can have a positive influence and is slow to reverse; portfolio flows are less helpful and can be swiftly withdrawn; there is much less evidence on speculation.    \citet{Ozan} finds that for the period 1990 to 2003, a capital inflow that is dominated by private loans and portfolio flows rather than direct investment is more likely to be followed by a sudden stop.   \citet{RazinCap} identify a pecking order to financial flows with FDI having the least cost in terms of reversal risk; equity flows generally being less prone to stops and reversals; and, debt, particularly with short maturity, being the most risky. Roderick and Velasco study xx countries and find that those with the highest proportion of debt are the most likely to suffer financial flow reversal. However, \citet{MontielReinhart} find that foreign exchange intervention, particularly if sterlisized,  can exacerbate the attacton of short-term speculative flows by increasing domestic interest rates and by encouraging the belief that exhange rate stability will be promted by the central bank.    

There appear to be two major components to speculative currency activity: the a momentum effect and the carry-trade. Each of these can contribute to the osscilation of capital surges and capital stops.  The momentum is associated wtih a gradual building of positive sentiment and an occasional sharp, unexpected reversal of opinion.  The carry trade is tries to take advantage of the failure of Uncovered-interest-parity (UIP) to hold.  It usually involves borrowing at releatively low rates in \emph{funding currencies} such as the US dollar, Japanese yen, Swiss franc or Euro and using the proceeds to deposit in higher interest rates currencies.  This can cause disruption when large inflows become a constraint on monetary policy and even larger problems when inflows reverse as traders rush to close their exposed positions. 

Identifying speculative flows has been a challenge due to the scarcity of data.  A standard approach has been to use \citet{BISbanking}. For example, \citet{Bruno2014} model the global liquidity cycle of internationa banks; \citet{AdamsKaneGlobal} try to assess the relative importance or willingness to lend, liqudity and solvency in determing capital flow.  However, it is difficult within this data to distinguish between bank lending for real business projects and that for speculative activity.  A bank loan that originates from overseas is much more likely to be beneficial for the recipient country than one that is merely financing an exchange rate speculation. Although, \citet{Cerutti2014} combine BIS with proprietory data to analyse the flow between international and local banks. 

The investigation of these issues has also been constrained by the relative absence of theoetical models.  There has been only limited progress in the development of exchange rate models that focus on capital flows.  The models that are being estavblished tend to be docused on traditional portfolo flows: particularly equities. There have been two major problems: identifying the variables to be used and modelling the relationship between portfolio choice and the exchange rate.  This paper seeks to address these three issues by broadening the range of capital flows that are included in the model and by using a structurla model to understand the relationship between capital flow and the exchange rate. In addition to discussing the empirical evidence that underpins the relationship between capital flows and the exchange rate, speculative activty is measured and the effect of exchange rate intervention is assessed.  There are three important contributions:  creating a structural model of international capita flows and the real exchange rate, adding speculation to the capital flow model and assessing the effect of speuclation in the model.   

\section{The model}\label{secref:2}
\subsection{Equilibrium}
From the initial identification by \citet{Cassel1916Present} of the relationship between relative prices and the exchange rates, purchasing power parity (PPP) has been the dominant method to understand the long-run equilibrium of exchange rates. The real exchange rate, where the nominal rate is adjusted for the prices in two countries, should remain stable.  However, there are prolonged periods where deviations from PPP are observed\footnote{Deviations from PPP are also called gains and losses in international competitiveness and have been associated with adverse effects on economic activity from Keynes' Economic Consequences of Mr. Churchill \citep{Keynes1925Churchill} through to current debate about competitiveness in the euro area. Therefore, understanding these elements is important for understanding economic welfare.} and it is not even clear whether the real exchange rate is \emph{stationary}.\footnote{Meaning, in this case, that it is mean-reverting.  See \citet{TaylorPPP} for a full discussion of this issue.}  \emph{The Penn Effect}\footnote{The relationship between the real exchange rate and the level of economic development that has been observed by \citet{harrod1933international},\citet{balassa1964ppp} and \citet{samuelson1964trade}.} and \emph{the Dutch disease}\footnote{The way that a resource discovery (usually oil or gas) can have on the real exchange rate through the improvement in the trade position and the demand for local currency.} are two explanation for this.  In addition it has been apparent that capital flows can also have a significant effect. For example, \citet{Geliman} construct real effective financial exchange rate to reflect the price competitiveness of a country's assets relative to its foreign competitors.     

% there needs to be something that combines Penn, Dutch discease and capital flows.  Read Intro to bath paper again.  
%However, there is intense debate about how far PPP holds and the \emph{Penn Effect}, whereby the real exchange rate appears to appreciate with economic development, is one of the factors suggesting that this relationship is not stable. There is evidence that exchange rates can show persistent divergence from the `equilibrium' of PPP, so that the \emph{real exchange rate} that is adjusted for prices is not stable and may not even be \emph{stationary}. \citet{TaylorPPP} discusses the power of unit root tests that have been applied to the real exchange rate and the issue of stationarity.  Deviations from PPP are also called gains and losses in international competitiveness and have been associated with adverse effects on economic activity from Keynes' Economic Consequences of Mr. Churchill \citep{Keynes1925Churchill} through to current debate about competitiveness in the euro area. 

%Some of the explanations for the deviations from PPP equilibrium revolve around the way that productivity in the traded-goods sector differs from that for non-traded. See \citet{harrod1933international}, \citet{balassa1964ppp} and \citet{samuelson1964trade} amongst others for an overview of this. Alternatively, this over-valuation may also be a consequence natural resource or other endowements that improve the balance of payments and drive up the value of the exchange rate relative to the PPP valuation.  While the \emph{Dutch disease} refers to the effect of a natural endowment can have on the real exchange rate and competitiveness, there has also been more recent attention on the way that a developed financial sector has affected the traded goods sector of countries like the US and the UK.  See \citet{CordenNeary} for a formal overview of the Dutch disease and \citet{SachsDutch} for an application of this to the UK. Here the infow of capital is regarded as a key factor behind the loss of competitiveness.    More recently, there has also been attention on the way that capital flows can affet the real exchange rate.  
%is the next paragraoh needed? 
\subsection{Capital Flow}
...
The financial account and the role that portfolio adjustment plays in the evolution of exchange rates has generally received less attention.  One of the founding models of international capital flows was presented by \citet{Branson1971}. This is a stock, equilibrium, reduced-form model where changes in capital flows depend on changes in relative interest rates and changes in the the size of the overall stock of savings.  This model takes the form

\begin{equation}
\Delta B^f = a_0 + a_1 \Delta R + a_2 \Delta R^* + a_3 \Delta E + u
\end{equation}

where $B^f$ is the share of foreign assets in the portfolio, $R$ is the domestic interest rate, $R^*$ is the overseas interest rate and $E$ is the level of risk aversion.  In this fixed-exchange-rate era, the risk on foreign assets is primarily an excahange rate realignment risk that is acccomodated, in this case, through the use of dummy variables to cover a descrete adjustment. 

The model is criticised by  \citet{Kouri1974International} and others for provding biased estimates of the elasticity of capital flows to interest rates, due to the failure to deal with the issue of endogeneity, and for abstracting from the effect of the domestic bond supply on capital outflows. \citet{Kouri1974International} develop a Portfolio Equilibrium model and extend Branson by adding the traditional monetary approach to the balance of payments. Capital flows are therefore affected by the domestic excess demand for money and interest rates are endogenous.   The model is very effective in explaining the capital flows in Germany, Italy, the Netherlands and Australia in the perild fixed exchange rate period of 1964 to 1970. It is estimated as,   

\begin{equation}
TC = \Delta Y + \Delta R^* + \Delta NDA + \Delta RR, 
\end{equation}

where $TC$ are the total private capital flows, $Y$ is national income, $\Delta R^*$ is the change in the overseas interest rate, $NDA$ are the net domestic assets of the central bank and $RR$ are the reserve requirements. In thoery the equation will also include domestic and overseas wealth and overseas income.  However, in the original, these elements have been dropped due to a lack of data. Again, the exchange rate is represented by a series of dummy variables to cover expected changes in the value of the exchange rate peg.   
  
A new practical interest in the relationship between the real exchange rate and capital flows developed at start of the millenium amidst the struggle to understand the initial weakenss of the euro against the US dollar and the related disconnect between the rise in the US current account deficit and the steady standing of the US dollar\footnote{The May 2001 World Economic Outlook from the IMF highlighted the failure of the models of the current account or interest rate differentials to explain US dollar strength \citet{imfweo2001} and the December 20000 issue of the Bank of England's Financial Stability Review considered the effect of portfolio flows.  The latter highlighting the \$206.1bn turnaround in US equity and foreign direct investment flows from an outflow of \$76.0bn in 1995-96 to an inflow of \$130.1bn in 1999-2000 as well as the mirror increase in the current account deficit \citet{BOEFSR2000}.}.   In addition, the increased availability of data has encouraged an interest in capital flows and the exchange rate.  Key international organisations have sought to improve the information that is being provided about international capital flows. These additions include the IMF's \citet{website:imfportfolio}, \citet{website:worldbankdebt} and \citet{website:bisdata} international banking data. There have also been a number of private initatives that have amalgamated existing information to create data series that can be used to analyse the key components of international capital.  Amongst these are \citet{PLane2007} as well as \citet{BoEdata}. More detailed and complete data has allowed more attention to be devoted to capital flows and their effects as well as details like the relationship between gross and net flows (example) and valuation effects from \citet{gourinchas2007world}. This has allowed new models to be tested against  the empirical evidence.   

For example, \citet{brookscapital} assess the ability of portfolio and foreign direct investment to track movements in the US dollar against the Yen and the Euro. They look at the relationship between the excess returns for the US market relative to that of the Euro area as an explanation for the capital flow and exchange rate changes. They estimate a simple least-squares reduced form model where the log of the exchange rate is regressed on net inflow of government, agency and corporate bonds, net equities and net FDI. Also included are relative long and short term interest rates, relative economic growth rates and relative stock returns.  They find that net flows from Europe into US equity markets track the performance of the Euro against the US dolloar, net FDI flows are less important; the movement of the Japanese yen is more tied to conventional variables like the current account and the interest rate differential. 

A standard linear empirical exchange rate model presented by \citet{Siourounis2004Capital}, he finds that net US equity purchase has a stable and consistent impact on UK, German and Swiss excahnge rates, but that net purchase of US or overseas bonds have no effect.   A vector auto-regression (VAR) is employed and impulse response functions (IRF) and variance decomposition are estimated to help understand the relative improtance of difference types of capital flow.  
  
A one-standard deviation shock to net equity purchase has the effect of a 10\% appreciation that is statistically significant for 13 months on average. Positive innovations in overseas equity returns are associated with short-run US dollar appreciation and repatriation for three of the four countries. Positive shocks to US interest rates cause US appreciation, rather than the depreciation that UIP would imply. This is consistent with the carry-trade. 

\citet{HauEquity} model the financial account of the balance of payments using the microstructure idea of order-flow to account for changes in the exchange rate.  This is an increasingly familiar approach (see \citet{Geliman}). However, while in the microstructure literature \citet{Evans2002Order}, \citet{Lyons1995Microstructure} and \citet{rime2010exchange} explain movements in currency with knowledge about market-maker and dealer orders, here the movement of international capital is the fulcrum of adjustment.
...
The foreige exchange market is assumed to be incomplete and the exchange rate follows a \emph{Ornstein-Uhlenbeck process}\footnote{This is a mean-reverting proceess that has the following stochastic difference equation: $dx_t = \theta(\mu - x_t)dt + \sigma dW_t$ where $W_t$ is the \emph{Wiener process} and $\theta$ , $\mu$ and $\sigma > 0$.} with a long-run equilibrium value of the exchange rate at $\bar{E}$ and a rate of mean reversion of $\alpha$. Therefore, the supply of currency to statisfy the imbalance of demand caused by net capital flows to overseas equity markets is 

\begin{equation}
Q^s = -\kappa(E_t - \bar{E})
\end{equation}

Therefore, excess net demand for overseas equities will cause an appreciation of the overseas currency as a means of inducing risk-averse market-makers and spculators to hold more domestic currency.  Speculators facilitate the decisions of equity investors through price concesssion. This is consistent with the Keynes-Hicks model of speculations.  See \citet{KeynesHedge} and \citet{HicksHedge}.   
...
Similarly, \citet{Blanchardint} try to determine whether central bank intervention in the foreign exchange market can be successful when there are no monetary or signalling effects.  Tne model here is determined much more by short-term speculation than relatively high interest rates. 

\begin{equation}
GPKI_{j,t} - GPKO_{j,t} + FXI_{j,t} +CA_{j,t} = 0
\end{equation}

where GPKI is gross private capital inflow and GPKO is gross capital outflow, FXI is official foreign exchange interventiona and CA is the current account position. 
...
where $i_{j,t}$ is the domestic interest rate, $i^*_t$ is the overseas interest rate, $e_{j,t}$ is the current exchange rate, $e_{j,t}$ is the exchange rate in the next period and $z_t$ is a set of exgenous variables that drive capital flows (such as risk appetite). 
...
with parameter $d$ in Equation \ref{eqref:cb1} identifying the extent to which monetary policy is determined by the exchange rate and $\phi$ in Equation \ref{eqref:cb2} the extent to which the central bank will respond to exogenous net private capital flows with offsetting foreign exchange intervention. 

It is assumed that exogenous capital flows ($z_t$) follow an AR process with a parameter $\Phi$.  This exogenous variation in capital flow is related to the changing attitudes towards risk aversion.  As risk aversion rises, capital tends to return home, as it rises capital seeks overseas destinations.  As such, this exigenous influence could also be related to speculative sentiment.  As shown in \citet{Hayward2013}, the carry-trade is more likely to be successful when conditions are calm and risk appetite high, carry-trades will be unwound during perilods of crisis and during high risk episodes. 
 
\citet{Gabaix2014} have the financiers' demand for Dollar bonds relative to Japanese yen bonds modelled as 

\begin{equation}
Q_0 = \frac{1}{\Gamma} \epsilon \left [e_o - e_1 \frac{R^*}{R} \right ]
\end{equation}

This is downward sloping as demand for US dollars decreases with the strenght of the dollar (declilne in $e_0$). $\Gamma$ controls the ability of financiers to take risk. The higher $\Gamma$ the lower the risk-baring and the steeper the demand curve. There are two extemes: when $\Gamma = 0$ financiers are able to bare any level of risk and UIP holds and trade imbalances are accomodated without any need for a change in the vlaue of the exchange rate; as $\Gamma \uparrow \infty$  financiers are unable to take any risk, there are no financial account transactions and the exchange rate is determined by trade imbalances. 

However, in the cases inbetween, for the market to clear in the basic two period model, 
...
There are two methodological issues to be addressed:  firstly, deciding on the appropriate variables to use in the model; second, dealing with the fact that all variables affect each other. 

There are a very wide range of economic variables that can be used to model exchange rates.  Even if these are narrowed down to those that are associated with financial flows and the financial account of the balance of payments, for a structural model, supply and demand must balance and forcing variables should be identified. Most of the models discuss above concentrate on the equity or bond flows and leave out the effects of speuclation, central bank activity and foreign direct intervention.  The possibility that these flows are important is allowed here.  

%The micro-structur literature may be added here.  Relate this to Hau and Rey; relate this to Blanchard with the risk aversion (need higher return as compensation for absorbing excess currency).   
The statistical difficulties that emerge when trying to estimate parameters when there is feedback from the dependent variable onto explanatory variables was an important part of the criticism of the Branson model.\footnote{See \citet{Branson1968} and \citet{Branson1971}.}  \citet{Kouri1974International} show that a linear regression of capital flows on interest rate differentials will systematically under-estimate the sensitivity of capital flows. The Brooks model suffers in the same way from being reduced form and therefore failing to deal with the issue of endogeneity.  This is something that is acknowledged by the authors \citet[note. 14, p 527]{brookscapital}.  The $R^2$ in their regression never rise above 0.1. This suggests that the values of the coefficients should be treated with some caution.  As capital flows and the exchange rate are determined simultaneously, a structural model is required.  VAR is one way of dealing with the issue of endogeneity.  The method was initially suggested by \citet{Sims1980Macroeconomics}.  An overview of developments and extensions can be found in \citet{lutkepohlvar} and \citet{Hamilton}. 

The essence of the VAR is to set up a system that is made up of all the important variables, assume that they are endogenous and that there are significant lags to remove any serial correlation from the equation residuals.   The variables used here are cumulative net equity flows, net bond flows, net foreign direct investment, net official purchase and two variable for speculative activity. The cumulative flows produces a stock of international financial assets so changes in thse stocks are related to changes in the real ecchange rate.  

The FDI data come from the US balance of payments, net portfolio flows are from the US Treasury Internatioanl Capital data, specuative momentum is based on CFTC specualtive positions and the interest rate differential is a proxy for the carry-trade. Fuller details of the variables, their source and data preparation are in the Appendix \ref{app1}.   

The preferred model, according to the range of information and diagnostics is the one that does not include the current account, has four lags and uses the three dummy variables as well as the S1 and SPREAD2 measures of sentiment and interest rates.  A model with a linear trend and a constant is the one that produces the lowest values of the AIC and BIC.  The summary information is presented in Appendix \ref{app2}.  It reveals that the system is stable as the roots of the autoregressive coefficients are all within the unit circle.    
...
Exogenous variables can be added to the VAR. These could include an intercept, a drift term, seasonal dummies or dummies to account for any structural breaks.  There are three exogenous dummy variables that cover periods of unusual activity.  The first dummy (D1) runs from the third quarter of 1986 to the first quarter of 1988.  This is an extreme move in the variable SPREAD1 caused by a sharp movement in Mexican interest rates. The second dummy (D2) covers the period from the second quarter of 1994 to the second quarter of 1995 to encompas a significant increase in US interest rates and the exceptional international outflows from the US bond market.   The third dummy (D3) runs from the third quarter of 2007 to the end of 2008 and represents the disturbance caused by the GFC. 
...
Now the equations are in reduced form.  Hamilton shows that the ordinary-least-squares estimator is the equivalent to the Maximum Likelihood Estimator (MLE) \citet[p. 293]{Hamilton}.  However, though the model can be estimated with ease, because of the transformation that has been undertaken, the coefficients that are of interesting in the structural model have been transformed. $A_0=B^{-1}\Gamma_0$, $A_1=B^{-1}\Gamma_1$ and $e_t=B^{-1}\epsilon_t$. Some method must be established to uncover the structural parameters.  As there are seven variables twenty one restrictions are requried for identification.  In general, $K(K-1)/2$ restrictions will be required, where K is the number of endogenous  variables in the VAR.

\subsection{Identification}\label{secref:ident}
There are a wide variety of methods that can be used to restrict the equation for indentification.   \citet{Siourounis2004Capital} uses a relatively simple adjustment of the B matrix from Equation \ref{transitionvar} to set all the lower-triangle elements to zero.  The disadvantage of this is that the estimated values of the contempraneous coefficients will be determined in part by the order that the variables are included in the VAR (see \citet[pp303-311]{EndersTS} for  a full discussion).  The Sims-Bernanke approach, to use economic theory to place restrictions on some of the parameters, is adopted here. In assessing the relative importance of fiscal and monetary policy in economci activity,  \citet{Sims1986} proposed a six-variable VAR including variables like GNP, money supply, interest rates, inflation, investment and unemployment and made 17 restrictions that the system was \emph{over-identified}. Similarly,  \citet{Bernanke1986} made a number of explicit restrictions to support his assertion that the relationship between money and income is intermediated by credit rather than being the result of money illusion or causality running from income to money.  
...
The IRF will show the average effect that is expected given the estimated parameters.  However, the parameters are estimated with some imprecision and therefore it is usual to also draw some confidence intervals around the path to show the range of possible outcomes.  There are two methods for constructing the confidence intervals.  The first is to assume that the error in estimating the coefficients of the system has a particular diestributon and then use estimates of the parameters of that distribution to find confidence levels.  However, with multicollinearity of the VAR, it is better to use the underlying data to assess the precision of the IRFs by using the \emph{bootstrap method}.  
...
\graphicspath{{../Figures2/}}
\centering
\caption{Impulse Response Functions for RTWI for Specificatin Two}
\label{fig:IRF2}  
...
What goes in here?  Diagnositc tests and table for the different models? 
\end{appendices}
\end{document}