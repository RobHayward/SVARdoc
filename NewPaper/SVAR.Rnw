...
The second speculative series is based on the activity of the \emph{carry-trade} which is an attempt to take advantage of a breakdown in uncovered interest parity (UIP).  See citations requred. The interest rate data are taken from the IMF International Financial Statistics.  The interest rates are short-term interest rates and usually 'money market rates' where available.  The three month rate is used. An index of international money rates is compiled and compared to the equivalent US interest rate.
