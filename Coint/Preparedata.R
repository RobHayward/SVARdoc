...
library(dse)
library(vars)
# The file is copied to desktop.  Path to Google drive- does not work. 
d <- read.csv("C://Users/Toshiba/Desktop/VAR data.csv", header=TRUE, sep=",")
head(d)
...
#head(da)
#scale can do this.  See help for options. 
#dan<-scale(da)
#head(dan)
#  Dummy Variables###########################################################
# D1
