...
# System 2 CNB---------------------------------------
irf.rtwicnb <- irf(Var2, n.ahead=4,impulse='CNB', response='RTWI',ortho=TRUE, 
                   cumulative=TRUE,boot=TRUE, runs=100)
a<-irf.rtwicnb$irf
b<-irf.rtwicnb$Upper
c<-irf.rtwicnb$Lower
aa<-data.frame(c(a,b,c))
plot(aa[,1], xlim=c(1,4), ylim=c(-2, 2), type='l',
...
# System 2 CNE------------
irf.rtwicne <- irf(Var2, n.ahead=4,impulse='CNE', response='RTWI',ortho=TRUE, 
                   cumulative=TRUE,boot=TRUE, runs=100)
a<-irf.rtwicne$irf
b<-irf.rtwicne$Upper
c<-irf.rtwicne$Lower
...
# System 2 CNFDI --------------------------------
irf.rtwicnfdi <- irf(Var2, n.ahead=4,impulse='CNFDI', response='RTWI',ortho=TRUE, 
                     cumulative=TRUE,boot=TRUE, runs=100)
a<-irf.rtwicnfdi$irf
...
abline(h=0, col='red',lty=6)
# System 2 COT--------------------------------------
irf.rtwicot <- irf(Var2, n.ahead=4,impulse='COT', response='RTWI',ortho=TRUE, 
                   cumulative=TRUE,boot=TRUE, runs=100)
a<-irf.rtwicot$irf
b<-irf.rtwicot$Upper
c<-irf.rtwicot$Lower
...
abline(h=0, col='red',lty=6)
# System 2 Spread----------------------------
irf.rtwispread <- irf(Var2, n.ahead=4,impulse='SPREAD2', response='RTWI',ortho=TRUE, 
                      cumulative=TRUE,boot=TRUE, runs=100)
...
abline(h=0, col='red',lty=6)
# system 2 Sentiment ------------------------------------------------
irf.rtwisent <- irf(Var2, n.ahead=4,impulse='S1', response='RTWI',ortho=TRUE, 
                    cumulative=TRUE,boot=TRUE, runs=100)
a<-irf.rtwisent$irf
